...
namespace uPLibrary.Networking.M2Mqtt.Messages
	...
	public class MqttMsgConnect : MqttMsgBase
		...
		public MqttMsgConnect (
			...
			ushort keepAlivePeriod, byte protocolVersion)
			{
			this.type = MQTT_MSG_CONNECT_TYPE;
		...
		public static MqttMsgConnect Parse (byte fixedHeaderFirstByte, byte protocolVersion, IMqttNetworkChannel channel)
			...
			if ((msg.protocolVersion == PROTOCOL_VERSION_V3_1_1) && ((buffer[index] & RESERVED_FLAG_MASK) != 0x00))
		...
		public override byte[] GetBytes (byte protocolVersion)
			...
			if (this.protocolVersion == PROTOCOL_VERSION_V3_1_1)
				...
				if (this.willFlag
					&& ((this.willQosLevel >= 0x03) || (willTopicUtf8 == null) || (willMessageUtf8 == null) || ((willTopicUtf8 != null) && (willTopicUtf8.Length == 0))
				...
				else if (!this.willFlag
							&& ((this.willRetain) || (willTopicUtf8 != null) || (willMessageUtf8 != null) || ((willTopicUtf8 != null) && (willTopicUtf8.Length != 0))
								|| ((willMessageUtf8 != null) && (willMessageUtf8.Length != 0))))
					throw new MqttClientException (MqttClientErrorCode.WillWrong);
				}
			...
			if ((this.willQosLevel < MqttMsgBase.QOS_LEVEL_AT_MOST_ONCE) || (this.willQosLevel > MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE))
				throw new MqttClientException (MqttClientErrorCode.WillWrong);
		...
		public override string ToString ()
			{
#if TRACE
			return this.GetTraceString ("CONNECT",
				new object[]
					{
				...
				new object[]
					{
					this.protocolName, this.protocolVersion, this.clientId, this.willFlag, this.willRetain, this.willQosLevel, this.willTopic, this.willMessage, this.username,
					this.password, this.cleanSession, this.keepAlivePeriod
					});
#else
