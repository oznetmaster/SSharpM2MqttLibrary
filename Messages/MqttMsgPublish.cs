...
namespace uPLibrary.Networking.M2Mqtt.Messages
	...
	public class MqttMsgPublish : MqttMsgBase
		...
		public static MqttMsgPublish Parse (byte fixedHeaderFirstByte, byte protocolVersion, IMqttNetworkChannel channel)
			...
			// message id is valid only with QOS level 1 or QOS level 2
			if ((msg.qosLevel == QOS_LEVEL_AT_LEAST_ONCE) || (msg.qosLevel == QOS_LEVEL_EXACTLY_ONCE))
				{
				// message id
		...
		public override string ToString ()
			{
#if TRACE
			return this.GetTraceString ("PUBLISH", new object[] {"messageId", "topic", "message"}, new object[] {this.messageId, this.topic, this.message});
#else
